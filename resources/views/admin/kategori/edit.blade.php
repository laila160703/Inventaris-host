    ...
    <div class="py-4">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <h2 class="text-xl font-bold text-gray-800 dark:text-white mb-6">Edit Kategori</h2>
                ...
                <form method="POST" action="{{ route('admin.kategori.update', $kategori->id) }}">
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="submit"
                            class="bg-green-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-green-700 focus:ring-2 focus:ring-green-500 transition duration-200 ease-in-out">
                            Update
                        </button>
